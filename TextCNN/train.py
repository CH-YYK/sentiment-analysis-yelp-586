...
from TextCNN.data_utils import data_tool
    ...
    def __init__(self, train_data_path, test_data_path, corpus_path, word_vector_path, batch_size, epoch_size,
        ...
        with tf.Graph().as_default():
            ...
            with self.sess.as_default():
                ...
                train_summary_dir = os.path.join(outdir, "TextCNN_runs", temp_dir, "summaries", "train")
                train_summary_writer = tf.summary.FileWriter(train_summary_dir, self.sess.graph)

                # Test Summaries
                test_summary_op = tf.summary.merge([loss_summary, acc_summary])
                test_summary_dir = os.path.join(outdir, 'TextCNN_runs', temp_dir, 'summaries', 'test')
...
if __name__ == '__main__':
    ...
    test = Training(train_data_path, test_data_path, corpus_path, word_vect, epoch_size=30)
