...
class data_tool(object):
    ...
    def batches_generate_old(self, data_x, data_y, epoch_size=10, batch_size=64, shuffle=True):
        """
        generate training batches
        """
        data_size = len(data_y)
...
if __name__ == '__main__':
    ...
    test = data_tool(data_path=data_path, corpus_path=corpus_path, word_vector_path=word_vect, review_size=5, len_words=150, Glove_path=None)
