...
parser.add_argument('-e', '--epoch_size', type=int, default=0, help='Set the epoch size during training')
...
parser.add_argument('-d', '--Data', default='./data/reviews_2013.tsv', help='The path to the data set')
